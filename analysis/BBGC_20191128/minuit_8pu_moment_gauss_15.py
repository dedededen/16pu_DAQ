...
### data
measure_vol = np.loadtxt("vol15.txt")

### matrix  invA_8pu_1_1-7MHz_1st.txt*
inv_A_8 = [ np.loadtxt("./matrix/invA_8pu_"+str(i) +"_3-4MHz_1st.txt") for i in range(2) ]
...
def plot_gain():
    ...
    np.savetxt('./gain_1st.txt',gain)
    np.savetxt('./gain_e_1st.txt',gain_e)
    print(gain,gain_e)
